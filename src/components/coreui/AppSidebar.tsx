    ...
    >
      <CSidebarHeader className="border-bottom">
        <CSidebarBrand className="d-flex align-items-center gap-2 text-decoration-none" as={NavLink} to="/dashboard">
          <span className="d-flex align-items-center justify-content-center rounded bg-success text-dark" style={{ width: 36, height: 36 }}>
            <CIcon icon={cilWallet} size="lg" />
          </span>
          <span className="sidebar-brand-full fw-bold">LKH SkyNet</span>
        </CSidebarBrand>
        <CCloseButton className="d-lg-none" dark onClick={() => onVisibleChange(false)} />
      </CSidebarHeader>
