...
export const LKH_PERIOD_PROFILES: LkhPeriodProfile[] = [
  ...
  },
  {
    ...
    year: 2026,
    month: 2,
    fileName: 'LKH SKYNET PERIODE 2026 - FEBRUARI (2).csv',
    columns: standardColumns,
    stopLabels: standardStopLabels,
    reportedBalanceMode: 'auto',
    cashAdvanceModes: standardCashAdvanceModes,
    expected: {
      ...
      ledgerRows: 375,
      totalIncome: 35873500,
      totalExpense: 32166912,
  ...
  },
  {
    ...
    year: 2026,
    month: 3,
    fileName: 'LKH SKYNET PERIODE 2026 - MARET (2).csv',
    columns: standardColumns,
    stopLabels: standardStopLabels,
    reportedBalanceMode: 'auto',
    cashAdvanceModes: standardCashAdvanceModes,
    expected: {
      ...
      ledgerRows: 293,
      totalIncome: 30253115,
      totalExpense: 25810320,
      closingBalance: 5126500,
      reportedCashAdvanceTotal: 4756500,
      reportedCashOnHand: 370000,
      cashAdvanceRows: 53,
  ...
  },
  {
    ...
    year: 2026,
    month: 4,
    fileName: 'LKH SKYNET PERIODE 2026 - APRIL (2).csv',
    columns: standardColumns,
    stopLabels: standardStopLabels,
    reportedBalanceMode: 'auto',
    cashAdvanceModes: standardCashAdvanceModes,
    expected: {
      ...
      ledgerRows: 393,
      totalIncome: 31616499,
      totalExpense: 24020269,
  ...
  },
  {
    ...
    year: 2026,
    month: 5,
    fileName: 'LKH SKYNET PERIODE 2026 - MEI (2).csv',
    columns: standardColumns,
    stopLabels: standardStopLabels,
    reportedBalanceMode: 'auto',
    cashAdvanceModes: standardCashAdvanceModes,
    expected: {
      openingBalance: 0,
      ledgerRows: 431,
      totalIncome: 35418130,
      totalExpense: 30234169,
      closingBalance: 5183961,
      reportedClosingBalance: 5183961,
      reportedCashAdvanceTotal: 3585500,
      reportedCashOnHand: 1598461,
      cashAdvanceRows: 39,
